...
class COCOEvaluatorDiscovery(COCOEvaluator):
    """
    ...
    def _eval_predictions(self, predictions):
        ...
        self._logger.info("[Evaluator new] Preparing results in the COCO format ...")
        lvis_results = list(itertools.chain(*[x["instances"] for x in predictions]))
        print('results :', lvis_results)
...
def _evaluate_predictions_on_lvis(
    ...
    lvis_results = COCOResults(lvis_gt, lvis_results, max_dets=max_dets_per_image)
    if known_class_ids is not None:
        lvis_eval = COCOEvalDiscovery(lvis_gt, lvis_results, iou_type, known_class_ids)
    else:
        lvis_eval = COCOeval(lvis_gt, lvis_results, iou_type)
    lvis_eval.run()
...
class COCOEvalDiscovery(COCOeval):
    """
